  ...
  return (
    <footer className="text-white">
      <div className="bg-black">
        <section className="padding width grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7 md:gap-10 ">
          <div>
            <Link href="/">
              <Image
                src={shortLogo}
      ...
      <div className="bg-[#202020]">
        <section className="padding width flex justify-between flex-col md:flex-row gap-4 text-sm text-[#CCCCCC]">
